	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float dotResult109 = dot( ase_viewDirSafeWS , -_MainLightPosition.xyz );
...
ASEEND*/
//CHKSM=8F249B3F621F51515FF64AE65DB22F28C2065AEF