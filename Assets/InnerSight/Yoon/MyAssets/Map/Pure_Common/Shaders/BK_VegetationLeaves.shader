	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryings VertexFunction( Attributes input  )
			{
				...
				float3 clampResult42_g6 = clamp( sin( ( MicroFrequency * ( ase_worldPos + simplePerlin2D47_g6 ) ) ) , float3( -1,-1,-1 ) , float3( 1,1,1 ) );
				float MicroWindColor287 = input.ase_color.r;
				float3 MicroWind152 = ( ( ( ( clampResult42_g6 * input.ase_normal ) * MicroPower ) * MicroWindColor287 ) * _MicroWindMultiplier );
...
Node;AmplifyShaderEditor.FunctionNode;410;-5354,1858;Inherit;False;BK_Wind;-1;;6;66f5c52931ac4a44aabf18a213395137;0;0;2;FLOAT3;56;FLOAT;57
...
Node;AmplifyShaderEditor.SamplerNode;65;-6334,-960;Inherit;True;Property;_Normal;Normal;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
ASEEND*/
//CHKSM=7F4ADEB115BCEF96B897D2E3EC0ED72EACDFA09B